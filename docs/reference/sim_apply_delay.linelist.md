...
#> $ symptom             <lgl> TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE, …
#> $ symptom_delay       <dbl> 3.664158, NA, 4.358404, 4.818922, NA, 5.131008, 3.…
#> $ symptom_time        <t[day]> 3.66, NA, 4.36, 4.82, NA, 5.13, 3.99, 3.4, NA, …
#> $ admitted            <lgl> FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, FALSE, TRU…
#> $ admitted_delay      <dbl> NA, NA, 7.316871, NA, NA, 8.308606, NA, 6.061053, …
#> $ admitted_time       <t[day]> NA, NA, 7.32, NA, NA, 8.31, NA, 6.06, NA, NA, N…
#> $ death               <lgl> FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, FALSE, TRU…
#> $ death_delay         <dbl> NA, NA, 13.25392, NA, NA, 14.57779, NA, 11.54329, …
#> $ death_time          <t[day]> NA, NA, 13.25, NA, NA, 14.58, NA, 11.54, NA, NA…
#> $ tested              <lgl> TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE, …
#> $ sample_delay        <dbl> 0.24998547, NA, 2.20460815, 0.75743935, NA, 0.4741…
#> $ sample_time         <t[day]> 0.25, NA, 2.2, 0.76, NA, 0.47, 2.05, 1.67, 2.43…
#> $ result_delay        <dbl> 0.24998547, NA, 2.20460815, 0.75743935, NA, 0.4741…
#> $ result_time         <t[day]> 0.5, NA, 4.41, 1.51, NA, 0.95, 4.09, 3.34, 4.86…
```
