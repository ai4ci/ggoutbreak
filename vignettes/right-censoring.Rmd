---
title: "Estimating the reproduction number from right censored data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Estimating the reproduction number from right censored data}
...
library(patchwork)
library(ggoutbreak)
here::i_am("vignettes/right-censoring.Rmd")
source(here::here("vignettes/vignette-utils.R"))

set_default_start("2025-01-01")
```

Right censoring typically is seen in epidemiological data as a result of delays
observing a proportion of patients.
