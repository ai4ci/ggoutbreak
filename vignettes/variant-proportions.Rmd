...
describing relative growth rates and is not shown here. The variant advantage in 
terms of reproduction number needs additional information about the infectivity
profile (aka generation time distribution) and as a result is much more complex.
