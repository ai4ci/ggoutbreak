...
pattern had changed and rates were uniform across age groups. In early 2021
...
actual value of the ascertainment rate calculated by this method depends on
assumptions on the duration of infection, however the relative change in this
number is informative (panel C).
