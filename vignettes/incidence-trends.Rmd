...
differential testing, but unfortunately testing denominator are not available in this data set.
...
disease is in the population but is also biased by test prioritisation. In this 
case the denominator is the number of cases in all age groups, and the 
proportions model tells us about the relative frequency of cases in each age group.
